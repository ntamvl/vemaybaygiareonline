...
<body <?php body_class(); ?>>
        ...
        <div class="navbar-header">
          ...
          <h1><a class="navbar-brand" href="<?php echo home_url(); ?>" title="<?php bloginfo('name'); ?>">
            <!-- <i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right arrow"></i> -->
              <?php //bloginfo('name'); ?>
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/logo.png" style="height: 50px; width: auto;">
            </a>
          </h1>
        </div>
            ...
            <div class="panel panel-default panel-search-box">
              <div class="panel-body">
                <?php get_template_part( 'search-box' ); ?>
					...
					<?php if ($specialPosts->have_posts() && false) : while($specialPosts->have_posts()) : $specialPosts->the_post(); ?>
					...
					<?php endwhile;  else : ?>
						...
						<p class="hide">Sorry, no posts matched your criteria.</p>
	...
	<div class="navbar navbar-inverse navbar-sub hide">
