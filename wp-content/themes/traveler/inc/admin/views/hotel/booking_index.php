...
echo '<h2>'.__('Hotel Booking',ST_TEXTDOMAIN).'<a href="'.admin_url('edit.php?post_type=st_hotel&page=st_hotel_booking&section=add_booking').'" class="add-new-h2">'.__('Add New',ST_TEXTDOMAIN).'</a></h2>';
        ...
        <thead>
            <tr>
                ...
                <th class="manage-column " width="7%">
                    <a href="#"><span><?php _e('Rooms',ST_TEXTDOMAIN)?></span><span class="sorting-indicator"></span></a>
                </th>
                <th class="manage-column" width="7%">
